    ...
    return(
        <div className="">
            ...
            <div className="w-3/4 md:w-4/5 lg:w-1/3 h-max shadow shadow-gray-300 bg-white p-3 rounded-md mx-auto mb-3">
                ...
                <div className="mt-8 ml-auto flex gap-4 w-max h-max">
                    <img src="images/unlove.png" width={25} />
                    <img src="images/comment.png" width={25}/>
                </div>
            </div>
            <div className="w-3/4 md:w-4/5 lg:w-1/3 h-max shadow shadow-gray-300 p-3 rounded-md mx-auto mb-3 bg-white">
                <div className="flex mt-2">
                    <div className="ml-2 w-10 h-10 rounded-full shadow">
                    <img src="images/user.png" className="rounded-full" width={40}/>
                    </div>
